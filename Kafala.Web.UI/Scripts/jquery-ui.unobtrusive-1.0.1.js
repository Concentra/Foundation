...
(function ($) {
    ...
    function initJQueryUI(elements) {
        ...
        ['autoOpen', 'closeOnEscape', 'closeText', 'dialogClass', 'disabled', 'draggable', 'height', 'maxHeight',
        'maxWidth', 'minHeight', 'minWidth', 'modal', 'resizable', 'stack', 'title', 'width', 'zIndex'], ['position'],
        ...
        'collapsible', 'event', 'fillSpace', 'header', 'heightStyle', 'navigation'], [], ['navigationFilter', 'create', 'activate', 'beforeActivate'],
        ['animate', 'icons']);
        ...
        ['active', 'cache', 'collapsible', 'deselectable', 'event', 'heightStyle', 'idPrefix', 'panelTemplate', 'selected', 'spinner', 'tabTemplate'],
        [],
        ['add', 'create', 'disable', 'enable', 'load', 'remove', 'beforeActivate', 'activate', 'beforeLoad'], ['ajaxOptions', 'cookie', 'fx', 'hide', 'show'], ['disabled']);
