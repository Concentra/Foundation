    ...
    public class BootstrapDynamicViewBuilder<TModel> : IDynamicViewBuilder<TModel>
    {
        ...
        public virtual MvcHtmlString Build(TModel model, BootstrapFormType formType)
        {
            ...
            using (var textWriter = new NavHtmlTextWritter(stringWriter))
            {
                ...
                {
                    BeginGroupLegend(textWriter, formElements, groupedElements);
                    ...
                    foreach (var formElement in groupedElements.OrderBy(x => x.ControlSpecs.Order))
                    {
                        ...
                        textWriter.RenderBeginTag((HtmlTextWriterTag) HtmlTextWriterTag.Div); // div (Control-Group)
        ...
        private static void BeginGroupLegend(NavHtmlTextWritter textWriter, List<FormElement> formElements, IGrouping<string, FormElement> groupedElements)
        {
        ...
        protected void RenderDynamicControl(NavHtmlTextWritter writer, TModel model, FormElement formElement)
        {
            ...
            var value = model == null ? null : property.GetValue(model, null);
